...
SECRET_KEY = 'django-insecure-d$ke21e0he3cfyfg--eet90_#)*be#3vff8k5kj%vegy4osab4'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'home.context_processors.getLinks',
                'home.context_processors.getCategory',
                'home.context_processors.getYear',
